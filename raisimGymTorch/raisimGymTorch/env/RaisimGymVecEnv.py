...
class RaisimGymVecEnv:
    ...
    def __init__(self, impl, logging_date, normalize_ob=True, seed=0, clip_obs=10.):
        ...
        self.wrapper.setLoggingDate(logging_date)
        self.count = 0.0
    ...
    def step(self, action, logging, iteration = 0):
        self.wrapper.step(action, self._reward, self._done, logging, iteration)
